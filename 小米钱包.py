...
#https://account.xiaomi.com/pass/serviceLogin?sid=xiaomiio&_json=true，通过浏览器的F12开发者工具，切换到应用程序选项卡，找到Cookies，找到https://account.xiaomi.com，可以看到passToken和userId的值
...
if __name__ == "__main__":
    ...
    ORIGINAL_COOKIES = [
        {   # 账号1
            'passToken': 'V1:',
            'userId': '983928319'
        }
        # 可继续添加更多账号...
    ]
